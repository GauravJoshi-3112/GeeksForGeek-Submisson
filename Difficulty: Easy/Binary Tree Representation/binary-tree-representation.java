...
class Solution{
    public static void createTree(Node root0, ArrayList<Integer> v ){
        ...
        Node rootLeft = root0.left;
        Node rootRight = root0.right;
        rootLeft.left = new Node(v.get(3));
        rootLeft.right = new Node(v.get(4));
        rootRight.left = new Node(v.get(5));
        rootRight.right = new Node(v.get(6));
    }
}
...
class Tree {
    ArrayList<Integer> postOrder(Node node) {
        ...
        // Create two Stack Stack1 , stack 2
        Stack<Node> stack1 = new Stack<>();
        Stack<Node> stack2 = new Stack<>();
        // Push Root Elem to Stack 1
        stack1.push(node);
        while(!stack1.empty()) {
            // loop Will traverse till we have element in Stack 1
            // In each Loop we will add last Element (in PostOrder) to Stack 2
